...
class ApplyRiskGateTests(unittest.TestCase):
    ...
    def test_small_account_hold_allows_non_worsening_overrun(self) -> None:
    ...
    def test_small_account_hold_rejects_worsening_overrun(self) -> None:
        hold = SmallAccountRiskHoldPolicy(
            enabled=True,
            hold_below_nav=1000.0,
            require_cash_only=True,
        ...
        result = apply_risk_gate(
            _decision(positions=(PositionTarget(symbol="SOXL", target_weight=0.95),)),
            max_single_weight=1.0,
            max_total_exposure=1.0,
            portfolio_snapshot=_portfolio_snapshot(),
            capital_base=_capital_base(reported_equity=472.0),
    ...
    def test_small_account_hold_disabled_for_large_nav(self) -> None:
        hold = SmallAccountRiskHoldPolicy(
            enabled=True,
            hold_below_nav=1000.0,
            require_cash_only=True,
        ...
        result = apply_risk_gate(
            ...
            max_total_exposure=1.0,
            portfolio_snapshot=_portfolio_snapshot(),
            capital_base=_capital_base(reported_equity=50_000.0),
            capital_base_binding=_capital_base_binding(),
            runtime_risk_limits=self._runtime_limits(),
            small_account_hold_policy=hold,
            current_portfolio_weights={"SOXL": 0.90},
