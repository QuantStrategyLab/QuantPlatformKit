...
def test_valid_legacy_live_candidate_notification_is_still_hold_only() -> None:
    ...
    assert (
        event.alert_key
        == "lifecycle/live_candidate/cn_equity/cn_chinext_growth_momentum_quality/live_candidate/hold"
    )
...
def test_runtime_enabled_notification_can_never_approve() -> None:
    result = validate_evidence_package(
        {
            "strategy_profile": "legacy_profile",
            "domain": "us_equity",
            "requested_stage": "runtime_enabled",
