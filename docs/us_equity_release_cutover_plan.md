...
## Intended live strategy matrix after cutover

| Platform service | Intended strategy profile | Notes |
| --- | --- | --- |
| `charles-schwab-quant-service` | `hybrid_growth_income` | TQQQ Growth Income should remain the Schwab live profile |
| `longbridge-quant-hk-service` | `tech_pullback_cash_buffer` | HK should move to QQQ Tech Enhancement |
| `longbridge-quant-sg-service` | `hybrid_growth_income` | SG should remain TQQQ Growth Income |
| `interactive-brokers-quant-service` | `semiconductor_rotation_income` | IBKR should move to SOXL/SOXX Semiconductor Trend Income |
