...
| LongBridge | `QuantStrategyLab/LongBridgePlatform` | `us_equity` | 每个区域服务设置 `STRATEGY_PROFILE=<runtime_enabled us_equity profile>` | Cloud Run | `longbridgequant` | `longbridge-quant-hk-service`、`longbridge-quant-sg-service` |
