...
@dataclass(frozen=True)
class StrategyPluginEmailAlertMarkerStore(CloudAlertMarkerStore):
    """Email-specific alert marker store — thin wrapper around shared base."""
    namespace: str = "strategy_plugin_email_alerts"
    schema_version: str = "strategy_plugin_email_alert_marker.v1"
