...
def assess_with_evidence(
    ...
    *,
    ...
    """Fail closed with a redacted, canonical risk-gate assessment receipt."""
    now = _utc_now()
...
def apply_risk_gate(
    ...
    *,
    ...
    if risk_mandate_id not in {None, _APPROVED_BOOTSTRAP_MANDATE}:
        return _reject(
            decision,
