...
STRATEGY_PLUGIN_I18N: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "strategy_plugin_error_reason_OSError": "插件信号文件读取失败",
        "strategy_plugin_error_reason_default": "插件加载异常（技术详情见执行报告）",
    ...
    "en": {
        ...
        "strategy_plugin_error_reason_PermissionError": "plugin signal file permission denied",
        "strategy_plugin_error_reason_ValueError": "plugin configuration validation failed",
        "strategy_plugin_error_reason_OSError": "plugin signal file read failed",
        "strategy_plugin_error_reason_default": "plugin load failed; see execution report diagnostics",
